...
public class BookCollection {
	...
	public List<Book> findBooks(Predicate<Book> searchCriteria) {     
        ...
        public Map<Integer, String> findBooksToMap(Predicate<Book> searchCriteria) {
...
//           Map<Integer, String> myMap = results.stream().collect(Collectors.toMap(b->b.getId(), b-> b.getTitle()));
//           return myMap;
	}
	public BookCollection() {
        ...
        public Long nrOfBooksMatch(Predicate<Book> searchCriteria) {
